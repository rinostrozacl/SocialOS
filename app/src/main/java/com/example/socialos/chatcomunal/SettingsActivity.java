...
public class SettingsActivity extends AppCompatActivity {
                ...
                filePath.putFile(resultUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        if (task.isSuccessful()){
                            Toast.makeText(SettingsActivity.this, "La imagen se ha subido correctamente...", Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
    ...
    private void UpdateSettings()
    {
        ...
        if (TextUtils.isEmpty(setUserName) && TextUtils.isEmpty(setUserStatus)){
            ...
            if (TextUtils.isEmpty(setUserName)){
                Toast.makeText(this, "Por favor ingresa nombre de usuario primero...", Toast.LENGTH_SHORT).show();
            }
            if (TextUtils.isEmpty(setUserStatus)){
                Toast.makeText(this, "Por favor ingresa un estado primero...", Toast.LENGTH_SHORT).show();
            }
            else
            {
    ...
    {
        Intent mainIntent = new Intent(SettingsActivity.this, MainActivityChat.class);
